...
class CorePortalRenderer(context: BlockEntityRendererProvider.Context) : BlockEntityRenderer<CorePortalBlockEntity> {
    ...
    override fun render(
        ...
        face(consumer, matrix, 0f, 1f, 0f, 1f, 1f, 1f, 1f, 1f) // SOUTH
        face(consumer, matrix, 0f, 1f, 1f, 0f, 0f, 0f, 0f, 0f) // NORTH
        face(consumer, matrix, 1f, 1f, 1f, 0f, 0f, 1f, 1f, 0f) // EAST
        face(consumer, matrix, 0f, 0f, 0f, 1f, 0f, 1f, 1f, 0f) // WEST
        face(consumer, matrix, 0f, 1f, down, down, 0f, 0f, 1f, 1f) // DOWN
        face(consumer, matrix, 0f, 1f, up, up, 1f, 1f, 0f, 0f) // UP
    }

    private fun face(consumer: VertexConsumer, matrix: Matrix4f,
